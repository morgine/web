...
func newContext(rsp http.ResponseWriter, req *http.Request, handlers []Handler) *Context {
	return &Context{
		Writer:        rsp,
		Request:       req,
		query:         nil,
